...
df[outlier_columns[:3] + ['label']
   ].plot.hist(by='label', figsize=(20, 10), layout=(3, 3))
plt.title("Histogram representation of Acceleron Record")
plt.show()

df[outlier_columns[3:] + ['label']
   ].plot.hist(by='label', figsize=(20, 10), layout=(3, 3))
plt.title("Histogram representation of Gyroscope Record")
plt.show()
...
# Loop over all columns
dataset= mark_outliers_lof(df,outlier_columns)
for col in outlier_columns:
...
# --------------------------------------------------------------
outliers_removed_df.to_csv('../../data/interim/outliers_removed.csv')
